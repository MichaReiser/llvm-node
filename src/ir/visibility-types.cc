...
NAN_MODULE_INIT(InitVisibilityTypes) {
    ...
    Nan::Set(visibilityTypes, Nan::New("Hidden").ToLocalChecked(), Nan::New(static_cast<uint32_t>(llvm::GlobalValue::VisibilityTypes::DefaultVisibility)));
    Nan::Set(visibilityTypes, Nan::New("Default").ToLocalChecked(), Nan::New(static_cast<uint32_t>(llvm::GlobalValue::VisibilityTypes::HiddenVisibility)));
