...
private:
    ...
    static NAN_METHOD(CreateICmpNE);
    static NAN_METHOD(CreateICmpSGE);
    static NAN_METHOD(CreateICmpSGT);
    static NAN_METHOD(CreateICmpSLT);
    static NAN_METHOD(CreateICmpSLE);
    static NAN_METHOD(CreateICmpUGE);
    static NAN_METHOD(CreateICmpUGT);
    static NAN_METHOD(CreateICmpULT);
    static NAN_METHOD(CreateICmpULE);
    static NAN_METHOD(CreateLoad);
    static NAN_METHOD(CreateLShr);
    static NAN_METHOD(CreateMul);
    static NAN_METHOD(CreateNeg);
    static NAN_METHOD(CreateNot);
    static NAN_METHOD(CreateOr);
    static NAN_METHOD(CreateXor);
    static NAN_METHOD(CreatePhi);
    static NAN_METHOD(CreatePtrToInt);
    static NAN_METHOD(CreateRet);
    static NAN_METHOD(CreateRetVoid);
    static NAN_METHOD(CreateSDiv);
    static NAN_METHOD(CreateSelect);
    static NAN_METHOD(CreateShl);
    static NAN_METHOD(CreateSub);
    static NAN_METHOD(CreateSRem);
    static NAN_METHOD(CreateURem);
    static NAN_METHOD(CreateSIToFP);
    static NAN_METHOD(CreateUIToFP);
